...
def main():
    ...
    with ThreadPool(max_workers=100) as SHOAIB:
        ...
        for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','FREE FIRE','free fire','i love you','mababa','bangladesh','Bangladesh','77889900','607080','60708090','১২৩৪৫৬','@@@###','09876543','637680']
